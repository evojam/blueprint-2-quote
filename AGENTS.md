# evojam-proptech — Standalone App Agent Rules
...
Enabled module facts: `ai_assistant`,`api_docs`,`attachments`,`audit_logs`,`auth`,`communication_channels`,`configs`,`currencies`,`customers`,`dashboards`,`dictionaries`,`directory`,`entities`,`events`,`feature_toggles`,`messages`,`notifications`,`query_index`,`search`.
